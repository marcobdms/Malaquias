        ...
        <div className="flex flex-col gap-4">
            ...
            {visibleCandidates.map((c, i) => {
                ...
                return (
                    <div 
                        key={i} 
                        className={`crystal-card overflow-visible transition-all duration-300 ${isTop ? 'bg-surface-container border-t border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.5)]' : 'bg-[#151515] border-white/5 hover:bg-[#1C1C1C] cursor-pointer'} border relative`}
